...
#define configBasic_HEAP_SIZE_DATA_OFF			20*1024
#define configBasic_HEAP_SIZE_DATA_ON			10*1024
#define configTOTAL_HEAP_SIZE_BUFFER_OFF		( ( size_t ) ( 32 ) )
#define configTOTAL_HEAP_SIZE_BUFFER_ON			( ( size_t ) ( 4*1024 ) )
