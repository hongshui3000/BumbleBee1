...
#define I2C_FLAG_MST_ACTIVITY                   ((uint32_t)0x10000020)
#define I2C_FLAG_RFF                            ((uint32_t)0x10000010)
#define I2C_FLAG_RFNE                           ((uint32_t)0x10000008)
#define I2C_FLAG_TFE                            ((uint32_t)0x10000004)
#define I2C_FLAG_TFNF                           ((uint32_t)0x10000002)
#define I2C_FLAG_ACTIVITY                       ((uint32_t)0x10000001)
...
#define I2C_GET_IT(IT)    (((IT) == I2C_INT_GEN_CALL) || ((IT) == I2C_INT_START_DET) || \
                           ((IT) == I2C_INT_STOP_DET) || ((IT) == I2C_INT_ACTIVITY) || \
                           ((IT) == I2C_INT_RX_DONE)  || ((IT) == I2C_INT_TX_ABRT) || \
                           ((IT) == I2C_INT_RD_REQ)   || ((IT) == I2C_INT_TX_EMPTY) || \
                           ((IT) == I2C_INT_TX_OVER)  || ((IT) == I2C_INT_RX_FULL) || \
                           ((IT) == I2C_INT_RX_OVER)  || ((IT) == I2C_INT_RX_UNDER))
/**
  * @}
  */
...
__STATIC_INLINE void I2C_SendData(I2C_TypeDef* I2Cx, uint8_t Data, FunctionalState StopState);
...
__STATIC_INLINE void I2C_SendData(I2C_TypeDef* I2Cx, uint8_t Data, FunctionalState StopState)
{
    ...
    I2Cx->IC_DATA_CMD = Data | (StopState << 9);    
}
...
__STATIC_INLINE ITStatus I2C_GetINTStatus(I2C_TypeDef* I2Cx, uint32_t I2C_IT)
{
    ...
    /* Check the parameters */
    assert_param(IS_I2C_ALL_PERIPH(I2Cx));
    assert_param(I2C_GET_IT(I2C_IT));
