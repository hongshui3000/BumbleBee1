...
void SPI_StructInit(SPI_InitTypeDef* SPI_InitStruct)
{
    ...
    SPI_InitStruct->SPI_Direction         = 0;                  /* 0:TX and RX Mode; 1:TX Only Mode; 2:RX Only Mode; 3:EEPROM Read Mode */
    SPI_InitStruct->SPI_CPOL              = 1;                  /* 0:inactive state of clock is low; 1:inactive state of clock is high */
    SPI_InitStruct->SPI_CPHA              = 1;                  /* 1:Serial clock toggles in first of first data bit;  0:Serial clock toggles in middle of first data bit*/                                                     
