...
*
*/
//typedef        unsigned char    UCHAR, BYTE,===>uint8_t
//typedef        unsigned short   WORD,   ===>uint16_t
//typedef        unsigned char    * LPBYTE;	===>uint8_t*
