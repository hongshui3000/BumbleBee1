...
typedef enum
{
    OBSERVER_ADV_SCAN_RSP_DATA_MSGTYPE = ADV_SCAN_RSP_DATA_MSGTYPE  //!< MSG used to sent received advertise or scan response data. 
...
extern bool observer_StartBtStack(void);
