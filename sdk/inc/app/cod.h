...
#define MINOR_DEVICE_CLASS_VOICE_GATEWAY          ((uint32_t)0x000010) /* 10 is ok!! */
...
#define MINOR_DEVICE_CLASS_PERIMULT_UNCATEGORIZED ((uint32_t)0x000000)   /* multifunction device definitions */
...
/* major class= IMAGING */
#define MINOR_DEVICE_IMAGE_DISPLAY                ((uint32_t)0x000010)    /* may be combined use as mask */
#define MINOR_DEVICE_IMAGE_CAMERA                 ((uint32_t)0x000020)    /* may be combined use as mask */
#define MINOR_DEVICE_IMAGE_SCANNER                ((uint32_t)0x000040)    /* may be combined use as mask */
#define MINOR_DEVICE_IMAGE_PRINTER                ((uint32_t)0x000080)    /* may be combined use as mask */
