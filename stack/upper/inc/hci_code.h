...
*********************************************************************************************************
* @file       hci_code.h
* @brief     HCI Protocol Layer : HCI Codes
* @details   
*
* @author  	gordon
* @date      	2015-07-13
...
#define HCI_VERSION_20                          3
#define HCI_VERSION_21                          4
...
#define HCI_CHANGE_LOCAL_NAME                  (0x13 | (HCI_CONTROL      << 10))
...
#define HCI_SET_HOST_CONTROLLER_TO_HOST_FLOW   (0x31 | (HCI_CONTROL      << 10))
...
#define SET_AFH_HOST_CHANNEL_CLASSIFICATION             (0x3F | (HCI_CONTROL      << 10))
...
#define HCI_LE_REMOTE_CONNECTION_PARAMETER_REQUEST_REPLY        (0x20 | (HCI_LE_CONTROL   << 10))
#define LE_REMOTE_CONNECTION_PARAMETER_REQUEST_NEGATIVE_REPLY   (0x21 | (HCI_LE_CONTROL   << 10))
...
#define HCI_NO_OF_COMPLETED_PACKETS             0x13
...
#define HCI_LINKTYPE_SCO                        0x00
#define HCI_LINKTYPE_ACL                        0x01
#define HCI_LINKTYPE_ESCO                       0x02
...
#define COMPID_UNINITIALIZED                12345 /**< lets hope this does not get a conflict in the near future */
...
#define HCI_AIRCODING_TRANSPARENT 0x03
